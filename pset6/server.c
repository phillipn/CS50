...
{
    int lowcasepath[strlen(extension)+1];
    for (int i = 0; i<strlen(extension); i++) {
        lowcasepath[i]=tolower(extension[i]);
        }
        if (strcmp(lowcasepath, "css")==0) {
            return "text/css";
        } else if (strcmp(lowcasepath, "html")==0) {
            return "text/html";
        } else if (strcmp(lowcasepath, "gif")==0) {
            return "image/gif";
        } else if (strcmp(lowcasepath, "ico")==0) {
            return "image/x-icon";
        } else if (strcmp(lowcasepath, "jpg")==0) {
            return "image/jpeg";
        } else if (strcmp(lowcasepath, "js")==0) {
            return "text/javascript";
        } else if (strcmp(lowcasepath, "png")==0) {
            return "image/png";
        } else  {
            return NULL;
        }
